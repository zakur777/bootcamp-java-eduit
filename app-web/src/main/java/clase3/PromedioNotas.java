...
public class PromedioNotas {
	...
	public static void main(String[] args) {
		 ...
		 * Se debe ingresar las tres notas del a￱o.
		 * Si el promedio es igual o o mayor (>=) 7 informar por consola que est￡ aprobado.
		 * Si el promedio es menor a 7 informar por consola que no est￡ aprobado.
		 */
		...
		if (promedio >= 7) {
			System.out.println("Uds est￡ aprobado:" + promedio);
		} else {
			System.out.println("Uds no est￡ aprobado: " + promedio);
		}
